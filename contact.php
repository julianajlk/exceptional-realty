    ...
    <div class="wrapper clearfix">
      ...
      <section class="col-2 first shadow">
        ...
        <?php } else if ($_GET['s'] == 'error') { ?>
          <p>Error. Your message was not sent! Make sure you tyme in the proper verification numbers. <a href="contact.php">Click here to try again</a>. If issues persist, please send an email to the site admin (site admin emails here).</p>
       <?php } else { ?>}
        ...
        <form action="mailer.php" method="post">
          ...
          <input type="text" name="verify" class="verity-box" placeholder="verify you're humna">
          <img src="verify-img" src="verificationimage.php?<?php echo rand(0,9999) ?>" alt="verification image">
